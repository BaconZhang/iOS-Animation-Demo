...
class RepeatViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        //let raw = UIViewAnimationOptions.Repeat.rawValue | UIViewAnimationOptions.Autoreverse.rawValue
        
        //let options = UIViewAnimationOptions(rawValue: raw)
        
        UIView.animateWithDuration(1, delay: 0, options: [UIViewAnimationOptions.Autoreverse , UIViewAnimationOptions.Repeat ,UIViewAnimationOptions.CurveLinear], animations: {
